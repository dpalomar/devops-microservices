...
@SpringBootTest(classes = TodomsApp.class)
public class TodoResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_RECORDATORIO = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_RECORDATORIO = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(todoResource, "todoSearchRepository", todoSearchRepository);
    ...
    public void createTodo() throws Exception {
        ...
        assertThat(testTodo.getTitulo()).isEqualTo(DEFAULT_TITULO);
        assertThat(testTodo.getDescripcion()).isEqualTo(DEFAULT_DESCRIPCION);
        assertThat(testTodo.getRecordatorio()).isEqualTo(DEFAULT_RECORDATORIO);
    ...
    public void createTodoWithExistingId() throws Exception {
        ...
        restTodoMockMvc.perform(post("/api/todos")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingTodo)))
    ...
    public void getAllTodos() throws Exception {
        ...
        restTodoMockMvc.perform(get("/api/todos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].recordatorio").value(hasItem(sameInstant(DEFAULT_RECORDATORIO))));
    }
    ...
    public void getTodo() throws Exception {
        ...
        restTodoMockMvc.perform(get("/api/todos/{id}", todo.getId()))
            ...
            .andExpect(jsonPath("$.recordatorio").value(sameInstant(DEFAULT_RECORDATORIO)));
    }
    ...
    public void updateTodo() throws Exception {
        ...
        Todo testTodo = todoList.get(todoList.size() - 1);
        assertThat(testTodo.getTitulo()).isEqualTo(UPDATED_TITULO);
        assertThat(testTodo.getDescripcion()).isEqualTo(UPDATED_DESCRIPCION);
        assertThat(testTodo.getRecordatorio()).isEqualTo(UPDATED_RECORDATORIO);
